  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Промпты,
          <span className="block text-sage">которые работают</span>
        </h1>
        ...
        >
          Управляй всеми промптами из одного места. Нейросеть читает контекст, следит за структурой и мгновенно генерирует нужный результат.
        </p>
